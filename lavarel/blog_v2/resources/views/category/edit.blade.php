    ...
    <div class="col-xxl">
      <div class="card mb-4">
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-xl-12">
              <form action="/update_category/{{ $category->id }}" method="post" action="/action_page.php">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="meta_tag" name="meta_tag" value="{{ $category->meta_tag }}"
                      placeholder="" />
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <a href="" id="thumb-image" data-toggle="image" class="img-thumbnail">
                      <img id="img_image" name="img_image" src="{{empty($category->image) ? "
                      https://sandivietnam.com/image/cache/no_image-100x100.png" : $category->image}}" alt="" title="">
