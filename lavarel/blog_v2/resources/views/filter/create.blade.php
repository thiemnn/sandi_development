...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4"><span class="text-muted">Danh sách tùy chọn lọc/</span> Thêm tùy chọn lọc </h4>
    ...
    <div class="col-xxl">
      <div class="card mb-4">
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-xl-12">
              <form action="/create_filter" method="post" action="/action_page.php">
                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"><input
                  ...
                  <div class="col-xl-6">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" id="order_display" name="order_display" placeholder="" />
                      </div>
                    </div>
                    <div class="row mb-3">
                  ...
                  <div class="col-xl-6">
                    ...
                    <div class="div_select_categories">
                      ...
                      <div class="even">
                        <input type="checkbox" name="product_categories[]" value="{{ $item['id'] }}">
                        {{ $item['name'] }}<br>
                      </div>
                      @endforeach
                    </div>
