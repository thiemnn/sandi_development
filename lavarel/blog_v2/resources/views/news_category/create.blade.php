...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4"><span class="text-muted">Danh mục tin tức/</span> Thêm danh mục </h4>
    ...
    <div class="col-xxl">
      <div class="card mb-4">
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-xl-12">
              <form action="/create_news_category" method="post" action="/action_page.php">
